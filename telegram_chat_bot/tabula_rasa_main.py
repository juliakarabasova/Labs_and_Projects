...
def picture_start(update: Update, context: CallbackContext):
    update.message.reply_text('Введите ссылку на фото, которое хочешь скачать')
    return 'url'
...
def meme(update: Update, context: CallbackContext):
    pict = ['https://sun1-25.userapi.com/u2wSGl1o3ed1Ruwcb2FDml3WAb00zRWs2VE_gg/tQPC1lkJzhE.jpg',
            'https://sun1-24.userapi.com/oqctaKLHo8DWV4kBc_Hxp_ZUyqwxIo38trCFPA/8RTtQcLT2jI.jpg',
            'https://sun1-15.userapi.com/u-p8IbPqgUcfEjDodhH4r9ZwXemb7Kp01EotJQ/kprPiWEqnY8.jpg',
            'https://sun1-17.userapi.com/3NPQBHFZF6si4l8vHjZYDmtdEXjSWbR87FVCgw/kkXu8Msm-TQ.jpg',
            'https://sun1-19.userapi.com/GJQStfuV-dE2pU-eyaqO2-kB0n7QELxkkdjFDA/vrNO9L0dP6k.jpg']
    bot.send_photo(update.message.from_user.id, random.choice(pict))
    ...
    #print(r1.text)
    #2 = re.findall(r'https://vk/wall-147643048_4682\.com/wall-\d{1,20}_\d{1,6}\?reply=\d{1,6}', r1.text)
...
def gifka(update: Update, context: CallbackContext):
    gifka = [
        'https://psv4.userapi.com/c623800/u290624918/docs/d10/e305f34354cd/luchshee.gif?extra=D30j0fxXheDCLFEsfiwS3wA9hQOMFegh5wGyLLaipjBLVj65ge_OCaHTdi-9SeCptWGrpPcw4VJQ2ABD-WX-6t_0WyX3KwOB_O7SsZycTe-GF_Y_hkg2sxypO-eunc9xFpAl2E67vskYJmx6fQKgKg',
        'https://psv4.userapi.com/c810421/u140417658/docs/d83a947a5669/BumazhnySamoletik.gif?extra=ixxhWyGjZLmA1QUk0tODxp2oQ9NDgWL_UFIbzpPaTULuh3X1s6zP3SpfZZr5AGmksIBYs2dAOA9v7IIGr-gBSbaNVJPoagnJ2EwmZFVzDEFKD9Am_tqjV8VI_1dNaI1oRph6cRlNTluUvhpaQqhHBg',
        'https://psv4.userapi.com/c816238/u228012063/docs/48b884fe8aec/luchshee.gif?extra=7mf9RfTGbdFV1chJimMalKpbq2iFeZYfhG7IOa2r9MAn8wEjq5GlQam3EZR_axEg_A-8GCtAFaU7iAg_pAMEZ-FFfBh2knRkGwckgV9pjXPb4W1lz-TxyGNwKwvPoHnb2H8VgUKxcQYoX-ZlEQ3BXg']
    bot.send_animation(update.message.chat_id, random.choice(gifka))
